...
#define AC_FN0  ACTION_LAYER_TAP_KEY(1, KC_INS)
...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
     ...
     * ,---.   .---------------. ,---------------. ,---------------. ,-----------.             ,---.
     * |Esc|   |F1 |F2 |F3 |F4 | |F5 |F6 |F7 |F8 | |F9 |Mut|VDn|VUp| |PrS|ScL|Pau|             |Pwr|
     * `---'   `---------------' `---------------' `---------------' `-----------'             `---'
     * ,-----------------------------------------------------------. ,-----------. ,---------------. ,---.
     ...
     */
    [0] = UNIMAP_ADB(
    ESC,      F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  MUTE,VOLD,VOLU,       PSCR,SLCK,PAUS,                 PKEY,
    GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL,      BSPC,  FN0, HOME,PGUP,  NLCK,PEQL,PSLS,PAST,  VOLU,
     ...
     */
    [1] = UNIMAP_ADB(
    TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,F10, F11, F12,        TRNS,TRNS,TRNS,                 TRNS,
